...
export const ErrorCode = {
  ...
  MAX_THERAPISTS_REACHED: 'BIZ_010',
  SESSION_NOT_RESCHEDULABLE: 'BIZ_011',
  SESSION_ALREADY_STARTED: 'BIZ_012',
  SESSION_NOT_STARTED: 'BIZ_013',
  SESSION_ALREADY_RATED: 'BIZ_014',
  INVALID_SESSION_TRANSITION: 'BIZ_015',
  THERAPIST_NOT_ACCEPTING: 'BIZ_016',
  CANCELLATION_WINDOW_PASSED: 'BIZ_017',
  DUPLICATE_BOOKING: 'BIZ_018',
  NUDGE_NOT_FOUND: 'BIZ_019',
