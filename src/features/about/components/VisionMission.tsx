...
export default function VisionMission() {
    ...
    return (
        <section ref={sectionRef} className="w-full bg-white relative py-[80px]">
            <div className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-24 flex flex-col lg:flex-row items-center justify-between relative">
                ...
                >
                    <div className="mb-4">
                        <span className="text-[#18A2B8] uppercase tracking-widest text-[16px] font-bold" style={{ fontFamily: "'Manrope', sans-serif" }}>
                            SOUL YATRI'S
                        </span>
                        <h2 className="text-[48px] font-bold text-black mt-1 leading-tight" style={{ fontFamily: "'Playfair Display', serif" }}>
                            Vision & Mission
                        </h2>
                    </div>
                    ...
                    <div className="mt-8 space-y-6" style={{ fontFamily: "'Manrope', sans-serif" }}>
                        <div>
                            <h3 className="text-[28px] font-bold text-black mb-3">Our Vision</h3>
                            <p className="text-[#000000] opacity-80 text-[18px] leading-[30px] font-normal">
                        ...
                        <div className="pt-2">
                            <h3 className="text-[28px] font-bold text-black mb-3">Our Mission</h3>
                            <p className="text-[#000000] opacity-80 text-[18px] leading-[30px] font-normal">
