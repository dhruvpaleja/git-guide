        ...
        <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-6 mb-8 w-full font-sans">
            ...
            <div className="flex flex-col md:flex-row md:items-center gap-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <button className="w-10 h-10 rounded-full border border-gray-200 flex items-center justify-center text-gray-400 hover:text-gray-600 hover:bg-gray-50 transition-colors relative">
            ...
            <div className="flex flex-wrap items-center gap-4 relative">
                ...
                <div className="relative flex-1 min-w-[280px] max-w-[360px]">
                    <input
                        ...
                        className="w-full bg-gray-50 border border-gray-200 text-gray-700 text-sm rounded-[30px] py-2.5 px-5 placeholder:text-gray-400 focus:outline-none focus:ring-1 focus:ring-gray-300"
                    />
                    <Search className="w-4 h-4 text-gray-400 absolute right-4 top-1/2 -translate-y-1/2 cursor-pointer hover:text-gray-600" />
                </div>

                {/* Action Icons */}
                <button className="w-10 h-10 rounded-full border border-gray-200 flex items-center justify-center text-gray-400 hover:text-gray-600 hover:bg-gray-50 transition-colors">
                ...
                <div className="flex items-center gap-4 ml-2">
                    <button className="text-[13px] font-medium text-red-400 hover:text-red-500 transition-colors">Ignored Clients</button>
                    <button className="text-[13px] font-medium text-gray-500 hover:text-gray-700 transition-colors">Report</button>
                </div>
                ...
                <div className="absolute -bottom-8 right-0 xl:right-0 xl:top-20 mt-6 xl:mt-0 flex w-full xl:w-auto z-50">
                    <div className="bg-[#1e1e1e] text-white rounded-full py-[18px] px-8 md:px-[50px] flex items-center justify-between xl:justify-start gap-8 md:gap-[60px] w-full xl:w-max shadow-[0_20px_50px_rgba(0,0,0,0.3)]">
                        ...
                        <div className="flex items-center gap-3 md:gap-5 hidden sm:flex">
