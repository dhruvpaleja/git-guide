                    ...
                    <div className="space-y-4 sm:space-y-5 md:space-y-6 flex flex-col justify-center">
                        ...
                        <div className="space-y-1.5 md:space-y-2">
                            <div className="flex gap-1.5 md:gap-2 items-start">
                                ...
                                <span className="text-white font-semibold text-xs sm:text-sm md:text-base">Student Counselling.</span>
                            </div>
                        ...
                        <div className="space-y-1.5 md:space-y-2 pt-2 md:pt-3">
                            <div className="flex gap-1.5 md:gap-2 items-start">
                                ...
                                <span className="text-white font-semibold text-xs sm:text-sm md:text-base">The Mental Crisis Among Students.</span>
                            </div>
                            <p className="text-white/80 text-xs sm:text-sm md:text-base leading-relaxed tracking-tight">
                        ...
                        <div className="space-y-1.5 md:space-y-2 pt-2 md:pt-3">
                            <div className="flex gap-1.5 md:gap-2 items-start">
                                ...
                                <span className="text-white font-semibold text-xs sm:text-sm md:text-base">Our Student Counselling Services.</span>
                            </div>
                            <p className="text-white/80 text-xs sm:text-sm md:text-base leading-relaxed tracking-tight">
